  ...
  return (
    <SectionLayout id="certifications" title="CERTIFICATIONS">
      ...
      <div className="max-w-3xl mx-auto text-center mb-8">
        ...
        {/* Animated glowing underline beneath heading logic */}
        <div className="flex justify-center mt-4">
          <div className="h-1 w-20 bg-gradient-to-r from-transparent via-purple-500 to-transparent rounded-full shadow-[0_0_15px_rgba(168,85,247,0.8)] animate-pulse" />
        </div>
      </div>

      {/* Responsive Grid: 3 cols Desktop, 2 cols Tablet, 1 col Mobile */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-7xl mx-auto px-4 md:px-0">
